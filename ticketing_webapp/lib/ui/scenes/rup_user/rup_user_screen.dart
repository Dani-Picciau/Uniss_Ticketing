...
import 'package:ticketing_webapp/ui/scenes/rup_user/bloc/rup_user_state.dart';
import 'package:ticketing_webapp/ui/scenes/rup_user/config/admin_manager_menu_config.dart';
import 'package:ticketing_webapp/ui/scenes/rup_user/widget/admin_manager_content.dart';
...
class AdminManagerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocConsumer<AdminManagerCubit, AdminManagerState>(
